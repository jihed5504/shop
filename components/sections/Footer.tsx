...
export default function Footer() {
  return (
    <footer id="contact" className="bg-primary text-white relative overflow-hidden">
      {/* Background elements */}
      <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-accent via-secondary to-warm"></div>
      <div className="absolute bottom-0 right-0 w-96 h-96 rounded-full bg-accent/10 -translate-y-1/4 translate-x-1/2"></div>
      <div className="absolute top-1/2 left-0 w-72 h-72 rounded-full bg-warm/10 -translate-x-1/2"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
          ...
          <div>
            <div className="flex items-center mb-6">
              <div className="w-12 h-12 rounded-full bg-white/20 flex items-center justify-center mr-3">
                <h2 className="text-xl font-semibold text-white">TH</h2>
              </div>
              <h3 className="text-2xl font-semibold text-white">Tranquil Haven</h3>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/80">
              <li>
                <Link href="#hero" className="hover:text-white transition-colors flex items-center gap-2">
              ...
              <li>
                <Link href="#booking" className="hover:text-white transition-colors flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                  Book a Session
              ...
              <li>
                <Link href="#testimonials" className="hover:text-white transition-colors flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                  Testimonials
          ...
          <div>
            ...
            <address className="not-italic text-white/80 space-y-4">
              ...
              <div className="pt-4">
                <p className="font-medium text-white mb-3">Opening Hours:</p>
